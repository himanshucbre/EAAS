...
namespace EaaSAPI.Controllers
{
    public class AuthorizationController : Controller
    {
        ...
        private async Task<AuthenticationTicket> CreateTicketAsync(OpenIdConnectRequest request, ApplicationUser user)
        {
            ...
            {
                if (!string.IsNullOrWhiteSpace(user.AppKey))
                    identity.AddClaim(CustomClaimTypes.AppKey, user.AppKey, OpenIdConnectConstants.Destinations.IdentityToken);

                if (!string.IsNullOrWhiteSpace(user.AppSecret))
                    identity.AddClaim(CustomClaimTypes.AppSecret, user.AppSecret, OpenIdConnectConstants.Destinations.IdentityToken);
